...
export default function ScannedTicketTable({ thead, tbody, loader, type}) {
  ...
  const handleViewTicket = async (index) => {
    ...
    if (data.length > 0) {
      ...
      localStorage.setItem("redirectedFrom", type); // this will help user to come back to origin page 
    }
  };
